 ...
 <!-- Modal -->
	...
	<div class="modal-header">
		<button type="button" class="close" data-dismiss="modal" aria-hidden="true" onclick="javascript:window.location.href = window.location.href;">&times;</button>
		 <h4 class="modal-title"><?php echo _TEXT['FILE_OPEN'];?></h4>
	</div>			<!-- /modal-header -->
	...
	<div class="col-sm-6">
	<select  name="filename" class="form-control col-sm-offset-2" size="5" required oninvalid="this.setCustomValidity('<?php echo _TEXT['SELECT_FILE'];?>')" oninput="setCustomValidity('')">
	   <?php
	...
	<div class="col-md-12">
		...
		<button type="submit" class="btn btn-primary"  style="float:right;"><?php echo _TEXT['OPEN'];?></button>  
	</div>
	</div>
</form>
