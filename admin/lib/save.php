 ...
 <!-- Modal -->
	...
	<div class="modal-header">
		<button type="button" class="close" data-dismiss="modal" aria-hidden="true" onclick="javascript:window.location.href = window.location.href;">&times;</button>
		 <h4 class="modal-title"><?php echo _TEXT['FILE']. ' ', _TEXT['SAVE'];?></h4>
	</div>			<!-- /modal-header -->
	...
	<br/>
	<label class="col-sm-3 control-label"><?php echo _TEXT['FILE_NAME'];?>:</label> 
		<div class="col-sm-offset-3">
	   <input type="text" id="filename" name="filename" value="" placeholder="salesq1"size="50" required oninvalid="this.setCustomValidity('<?php echo _TEXT['ENTER_FILE_NAME'];?>')" oninput="setCustomValidity('')" />    
	</div><br/>
	...
	<div class="modal-footer">
		...
		<button type="submit" class="btn btn-primary"><?php echo _TEXT['SAVE'];?></button>
	</div>
</form>
